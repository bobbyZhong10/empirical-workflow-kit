...
| `bibliography-audit` | [`scunning1975/MixtapeTools`](https://github.com/scunning1975/MixtapeTools) | Scott Cunningham | Per-entry `.bib` verification against canonical metadata. |
| `latex-production --figures` | [`scunning1975/MixtapeTools`](https://github.com/scunning1975/MixtapeTools) | Scott Cunningham | The iterative TikZ refinement concept, extended here into a full compile / rasterize / review / fix loop. |
| `latex-production` | [`scunning1975/MixtapeTools`](https://github.com/scunning1975/MixtapeTools) | Scott Cunningham | Diffing the warning and overfull-box set between successive compiles and reporting the deltas. |
...
| `research-council` | [`chrisblattman/claudeblattman`](https://github.com/chrisblattman/claudeblattman) | Chris Blattman | N parallel critic subagents plus a separate synthesizer that does not majority-vote. |
| `manuscript-review` | [`claesbackman/AI-research-feedback`](https://github.com/claesbackman/AI-research-feedback) | Claes Bäckman | The six-agent referee-review fanout and the agent role names. |
| Buried-contribution gate in `manuscript-review` | [`aspi6246/Claude-Code-Presentation`](https://github.com/aspi6246/Claude-Code-Presentation) | aspi6246 | The mechanical check that flags a contribution sentence arriving too late in the abstract. |
...
- Literata, by TypeTogether for Google ([googlefonts/literata](https://github.com/googlefonts/literata)). SIL Open Font License 1.1; the license ships at `presentation-tooling/fonts/literata/OFL.txt`.
- IBM Plex Sans, by Mike Abbink and Bold Monday for IBM ([IBM/plex](https://github.com/IBM/plex)). SIL Open Font License 1.1; the license ships at `presentation-tooling/fonts/ibm-plex-sans/OFL.txt`.
- MathJax 2.7.9 ([mathjax/MathJax](https://github.com/mathjax/MathJax)). Apache License 2.0; the license ships at `presentation-tooling/mathjax/LICENSE`.
...
- Quarto ([quarto-dev/quarto-cli](https://github.com/quarto-dev/quarto-cli)). MIT. The render pipeline everything in `presentation-tooling/` extends.
