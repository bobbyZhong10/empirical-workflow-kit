...
(canon.md, current as of 2026-08-05): Imbens (2024) supplies the assumption axis
...
Refresh path: run literature-review on quasi-experimental methods in marketing since the canon date,
then propose additions to canon.md as flagged addenda.
...
of the Mixtape's Table 8.2 inadmissible here (details.md for the argument, the
...
## Stata FE standard errors instead (argument-name trap in details.md):
...
- Sensitivity analysis is mandatory, because unconfoundedness is untestable. The graded
  ladder (details in details.md): Manski bounds (assumption-free, honest,
...
Full argument: shared-rules.md.

## Implementation

template.R is the runnable path for the branch this skill owns
...
versions, links, and traps in details.md. Every other branch's code lives in
...
Every claim traces to canon.md; keys live in references.bib.
