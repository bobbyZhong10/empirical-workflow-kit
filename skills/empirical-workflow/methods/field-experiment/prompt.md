...
An opinionated experimental workflow grounded in a read canon (canon.md, current as
...
- Power before the experiment, with the closed-form minimum-N formula (worked example and
  algebra in details.md; a treated share of one half is optimal under
...
The complete runnable pipeline is template.R (assignment, RI + Neyman
