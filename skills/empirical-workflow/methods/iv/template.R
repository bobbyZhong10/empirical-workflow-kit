...
# With few clusters the F and chi2 versions of AR can diverge; check both (details.md).
...
# Read F.robust against the Keane-Neal ladder (details.md): 50 certifies ~29,
...
# empirical numbers are in details.md.
...
# implemented by ivmte; see details.md for the package row).
