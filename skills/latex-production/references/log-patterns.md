# Log-parsing reference for latex-production
...
```
$EWF_STATE_DIR/latex-production/<hash>/last.json
```
...
```json
{
  ...
  "master": "/path/to/Library/CloudStorage/Dropbox-Personal/Apps/Overleaf/Proj/main.tex",
  "engine": "pdflatex",
  "bib_backend": "bibtex",
  "status": "ok",
