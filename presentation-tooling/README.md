...
format:
  revealjs:
    ...
    incremental: true
filters:
  - $EWF_PRESENTATION_ASSETS/stage-slide.lua
```
...
```bash
node $EWF_PRESENTATION_ASSETS/deck-check.mjs fit deck.html [--json]
node $EWF_PRESENTATION_ASSETS/deck-check.mjs handout deck.html out.pdf
```
...
$EWF_PDF_HELPER png deck.pdf --pages 3 --dpi 110 --out /tmp/s
...
```bash
node $EWF_PRESENTATION_ASSETS/deck-check.mjs handout deck.html handout.pdf
```
